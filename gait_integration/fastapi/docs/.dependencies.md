# ⚙️ Auth Integration — FastAPI Dependency (`gait_integration/fastapi/dependencies.py`)
...
from gait_integration.fastapi.dependencies import verify_token
...
```
gait_integration/fastapi/dependencies.py
│
